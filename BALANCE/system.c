...
void systemInit(void)
{
	...
	TIM1_PWM_Init(MOTOR_PWM_TIM_ARR, MOTOR_PWM_TIM_PSC);
	TIM9_PWM_Init(MOTOR_PWM_TIM_ARR, MOTOR_PWM_TIM_PSC);
	TIM10_PWM_Init(MOTOR_PWM_TIM_ARR, MOTOR_PWM_TIM_PSC);
	TIM11_PWM_Init(MOTOR_PWM_TIM_ARR, MOTOR_PWM_TIM_PSC);
